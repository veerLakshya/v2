...
export const Card = (
  ...
  return (
    <div className={twMerge("relative z-0 p-8 md:p-10 group ", className)}>
      <div
        className={twMerge(
          "absolute size-16 bg-fuchsia-500 rounded-xl top-1.5 right-1.5 -z-10 transition duration-300 blur-lg opacity-0 group-hover:opacity-100",
      ...
      <div
        className={twMerge(
          "absolute size-16 bg-fuchsia-500 group-hover:bg-fuchsia-400 rounded-xl top-1.5 right-1.5 -z-10 transition duration-300",
